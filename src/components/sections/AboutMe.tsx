        ...
        <div className="mt-8 grid gap-8">
          ...
          >
            <div className="mb-8">
              ...
              <h3 className="text-3xl font-black tracking-[-0.04em] text-[color:var(--text)]">
                Vivência em produção, manutenção, engenharia e software.
              </h3>
            </div>

            <div className="grid gap-4">
              {aboutProfile.experiences.map((experience) => (
                <article
                  key={`${experience.company}-${experience.period}`}
                  className="relative rounded-[1.5rem] border border-[color:var(--line)] bg-[color:var(--panel-strong)] p-5"
                >
                  <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                    <div>
                      <h4 className="text-lg font-black text-[color:var(--text)]">
                        {experience.company}
                      </h4>
                      <p className="mt-1 text-sm font-bold text-[color:var(--accent)]">
                        {experience.role}
                      </p>
                    </div>
                    <span className="w-fit rounded-full border border-[color:var(--line)] px-3 py-1 text-xs font-black uppercase tracking-[0.14em] text-[color:var(--muted)]">
                      {experience.period}
                    </span>
                  </div>
